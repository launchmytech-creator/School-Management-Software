...
const AttendanceChart: React.FC<AttendanceChartProps> = ({ present, total, onViewDetails }) => {
      ...
      <div className="flex items-center gap-8">
        <div className="w-40 h-40 relative">
          {hasAttendance ? (
            ...
            <div className="w-full h-full flex flex-col items-center justify-center bg-slate-50 rounded-full">
              ...
              <span className="text-sm font-medium text-slate-400 text-center px-2">No attendance marked</span>
            </div>
          )}
        </div>
        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="flex justify-between items-center bg-rose-50 p-2.5 rounded-xl">
            ...
            <span className="text-rose-700 font-bold">{absent.toLocaleString()}</span>
          </div>
        </div>
      </div>
    </div>
