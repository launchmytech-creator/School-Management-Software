...
const FeeStatusChart: React.FC<FeeStatusChartProps> = ({ paid, pending, partial }) => {
  const data = [
  ...
  return (
    <div className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-lg font-display font-bold text-slate-800 tracking-tight">Fee Status Overview</h3>
        <button className="text-accent text-sm font-bold hover:underline">Full Report</button>
      </div>
      ...
      <div className="flex items-center gap-8">
        <div className="w-40 h-40 relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-xs font-bold text-slate-600">Collection</span>
          </div>
        </div>
