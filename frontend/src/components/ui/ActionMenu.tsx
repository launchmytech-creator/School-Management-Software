        ...
        <div className="absolute right-0 mt-2 w-40 bg-white rounded-xl shadow-lg border border-slate-100 py-1 z-50">
          {items.map((item) => (
            <button
              ...
              className={`w-full px-4 py-2.5 text-left flex items-center cursor-pointer  gap-2 text-sm transition-colors ${
                item.variant === "danger"
            ...
            >
              <span
                className={
                  item.variant === "danger" ? "text-rose-500" : "text-slate-400"
                }
              >
                {item.icon}
              </span>
