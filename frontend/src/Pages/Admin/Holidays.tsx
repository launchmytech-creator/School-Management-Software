...
const Holidays: React.FC = () => {
  ...
  const handleDeleteHoliday = (id: number, holidayName: string) => {
    setDeleteDialog({ isOpen: true, holidayId: id, holidayName });
  };

  const confirmDeleteHoliday = async () => {
    if (!deleteDialog.holidayId) return;
    setDeleting(true);
    try {
  ...
  return (
    <div className="max-w-[1200px] mx-auto">
      <PageHeader
        title="Holidays"
        subtitle="Manage school holidays and academic calendar"
        breadcrumb={{
          links: [
            { label: "Schedule", href: "/admin/holidays" },
                  ...
                  return (
                    ...
                    >
                      ...
                      {day.isSunday && day.isCurrentMonth && !day.holiday && (
                        <p className="text-[10px] mt-1 font-bold text-red-500 uppercase">
                          Sunday
                        </p>
                      )}
        ...
        <div className="col-span-4 flex flex-col gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex-1">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs font-bold text-blue-500 hover:underline cursor-pointer">
                View All
              </span>
            </div>
