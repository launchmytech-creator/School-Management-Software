  ...
  return (
    <div className="max-w-4xl mx-auto pb-20">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-3xl p-10 shadow-sm border border-slate-100">
            <div className="flex items-center gap-3 mb-10 pb-6 border-b border-slate-50">
              <div className={`p-2 rounded-xl ${formData.isActive ? 'bg-emerald-50' : 'bg-rose-50'}`}>
                {formData.isActive ? <CheckCircle2 className="text-emerald-500 size-6" /> : <XCircle className="text-rose-500 size-6" />}
              </div>
            ...
            <div className="flex items-center gap-4">
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                <span className="ml-4 text-sm font-bold text-slate-700 uppercase tracking-widest">
                  {formData.isActive ? 'Active Staff' : 'Inactive / Deactivated'}
                </span>
              </label>
            </div>
          </div>
