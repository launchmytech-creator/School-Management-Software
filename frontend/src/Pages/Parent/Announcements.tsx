  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* Stats Card */}
        <div className="bg-gradient-to-br from-[#4A9FD4] to-[#1E3A5F] rounded-2xl px-6 py-4 text-white shadow-lg">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 bg-slate-50 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#4A9FD4] focus:border-transparent transition-all"
          />
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {filteredAnnouncements.map((announcement) => (
            <div
              key={announcement.id}
              className="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-md hover:border-[#4A9FD4]/30 transition-all"
            >
              <div className="flex flex-col md:flex-row md:items-start gap-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 bg-[#4A9FD4]/10 rounded-xl flex items-center justify-center text-[#4A9FD4]">
                    <Megaphone className="w-6 h-6" />
                  </div>
                </div>
